                ...
                <ul class="nav__list" id="nav-list">
                    <li class="nav__list-item ">
                        <div class="nav__toggle-positioner">
                            <a href="#" class="nav__list-link ">Our Work</a> 
                        ...
                        <ul class="nav__dropdown" id="work">
                            <li class="nav__dropdown-item"><a href="#" class="nav__dropdown-link">Tri My Best</a></li>
                            <li class="nav__dropdown-item"><a href="#" class="nav__dropdown-link">Yoga</a></li>
                        </ul>
                        <div class="nav__dropdown-shadow" id="work-shadow"></div>
                    </li>
                    <li class="nav__list-item ">
                        <div class="nav__toggle-positioner">
                            <a href="#" class="nav__list-link ">Our Stories</a>
                    ...
                    <li class="nav__list-item ">
                        ...
                        <ul class="nav__dropdown" id="about">
                            <li class="nav__dropdown-item"><a href="#" class="nav__dropdown-link ">Our Mission and Values</a></li>
                            <li class="nav__dropdown-item"><a href="#" class="nav__dropdown-link ">Our Leadership</a></li> 
                        </ul>
                        <div class="nav__dropdown-shadow" id="about-shadow"></div>
                    </li>
                    <li class="nav__list-item ">
                        <div class="nav__toggle-positioner">
                            <a href="#" class="nav__list-link ">Get Involved</a>
                            <div class="nav__dropdown-toggle"onclick="toggleDropdown(this, 'involved')">
                                <img class="nav__dropdown-toggle-icon" src="./images/open_menu_icon.png"  />
                            </div>
                        </div>
                        <ul class="nav__dropdown" id="involved">
                            <li class="nav__dropdown-item"><a href="#" class="nav__dropdown-link ">Volunteering</a></li> 
                            <li class="nav__dropdown-item"><a href="#" class="nav__dropdown-link ">Fundraising</a></li> 
                            <li class="nav__dropdown-item"><a href="#" class="nav__dropdown-link ">Donating</a></li> 
                        </ul>
                    ...
                    <li class="nav__list-item mobile-nav__list-item" id="mobile-social-btns">
                            <a href="#" class="social-btn social-btn__mobile">
