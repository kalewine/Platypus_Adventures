class PlatypusFooter extends HTMLElement{connectedCallback(){this.innerHTML=`  <footer class="footer">
        ...
        </section>`}}customElements.define("platypus-sponsors",PlatypusSponsors);class IntroWaves extends HTMLElement{constructor(){super();const e=document.createElement("section"),t=(e.setAttribute("class","waves__container"),e.setAttribute("id","waves-intro"),document.createElement("img")),s=(t.setAttribute("class","waves__crests top-waves"),t.setAttribute("src","../../images/purple-waves-top.svg"),t.setAttribute("alt","upward wave crests"),document.createElement("img")),i=(s.setAttribute("class","waves__crests bottom-waves"),s.setAttribute("src","../../images/purple-waves-bottom.svg"),s.setAttribute("alt","downward wave crests"),document.createElement("div")),a=(i.setAttribute("class","waves__body waves__purple"),document.createElement("article")),o=(a.setAttribute("class","intro__content"),document.createElement("h1")),n=(o.setAttribute("class","intro__title"),o.textContent=this.getAttribute("intro-title"),document.createElement("p"));n.setAttribute("class","intro__text"),n.textContent=this.getAttribute("intro-text"),a.appendChild(o),a.appendChild(n),i.appendChild(a),e.appendChild(t),e.appendChild(i),e.appendChild(s),this.appendChild(e)}}class WavesDivider extends HTMLElement{constructor(){super();const e=document.createElement("section");e.setAttribute("class","waves__container");var t=this.getAttribute("background-color"),s=this.getAttribute("button-color"),d=this.getAttribute("link");const i=document.createElement("img"),a=(i.setAttribute("class","waves__crests top-waves"),i.setAttribute("src",`../../images/${t}-waves-top.svg`),i.setAttribute("alt","upward wave crests"),document.createElement("img")),o=(a.setAttribute("class","waves__crests bottom-waves"),a.setAttribute("src",`../../images/${t}-waves-bottom.svg`),a.setAttribute("alt","downward wave crests"),document.createElement("div")),n=(o.setAttribute("class","waves__body waves__"+t),document.createElement("article")),r=(n.setAttribute("class","divider__content"),document.createElement("h2")),l=(r.setAttribute("class","divider__text"),r.textContent=this.getAttribute("divider-text"),document.createElement("a"));if(l.setAttribute("href",""+d),l.setAttribute("class","button button__"+s),l.textContent=this.getAttribute("btn-text"),n.appendChild(r),this.hasAttribute("divider-paragraph")){const c=document.createElement("p");c.setAttribute("class","waves__paragraph"),c.textContent=this.getAttribute("divider-paragraph"),n.appendChild(c)}n.appendChild(l),o.appendChild(n),e.appendChild(i),e.appendChild(o),e.appendChild(a),this.appendChild(e)}}class HeaderWaves extends HTMLElement{constructor(){super();const e=document.createElement("section"),t=(e.setAttribute("class","header__waves"),document.createElement("img")),s=(t.setAttribute("class","waves__crests bottom-waves"),t.setAttribute("src","../../images/purple-waves-bottom.svg"),t.setAttribute("alt","downward wave crests"),document.createElement("div")),i=(s.setAttribute("class","waves__body waves__purple"),s.setAttribute("id","header-waves"),document.createElement("article")),a=(i.setAttribute("class","intro__content"),document.createElement("h1")),o=(a.setAttribute("class","intro__title"),a.textContent=this.getAttribute("intro-title"),document.createElement("p"));o.setAttribute("class","intro__text"),o.textContent=this.getAttribute("intro-text"),i.appendChild(a),i.appendChild(o),s.appendChild(i),e.appendChild(s),e.appendChild(t),this.appendChild(e)}}customElements.define("intro-waves",IntroWaves),customElements.define("waves-divider",WavesDivider),customElements.define("header-waves",HeaderWaves);const stories=document.getElementsByClassName("story__slider-card"),storyContainer=document.getElementById("story-slider"),storyScreen=document.getElementById("story-screen"),dots=document.getElementsByClassName("story__indicators-dot");let shiftBy,currentIndex=1;const changeStory=e=>{var t=storyScreen.getBoundingClientRect().width;let s;var i=stories.length;1==(s=-1==e?currentIndex==i?1:currentIndex+1:1<currentIndex?currentIndex-1:i)?shiftBy=0:s==i?shiftBy=-(i-1)*t:1<s&&(shiftBy=-t*(s-1)),dots[s-1].classList.add("filled"),dots[currentIndex-1].classList.remove("filled"),storyContainer.style.transform=`translateX(${shiftBy}px)`,currentIndex=s},changeDot=e=>{var t=storyScreen.getBoundingClientRect().width,s=(Array.from(dots).forEach(e=>e.classList.remove("filled")),Array.from(dots).indexOf(e));e.classList.add("filled"),shiftBy=0==s?0:-t*s,currentIndex=s+1,storyContainer.style.transform=`translateX(${shiftBy}px)`},srcset={0:{src:"tri-my-best-runner-and-buddies-approach-finishline",alt:"tri my best athlete and buddies run towards finishline"},1:{src:"tri-my-best-biker-red-helmet-smiles",alt:"tri my best biker in red helmet smiles"},2:{src:"tri-my-best-partcipant-holds-finish-strong-sign",alt:"tri my best participant holds finish strong sign"},3:{src:"tri-my-best-biker-in-tutu-bikes-with-buddies",alt:"tri my best biker in tutu bikes as buddies jog alongside"},4:{src:"tri-my-best-swimmer-smiles-at-camera",alt:"tri my best swimmer smiles at the camera"},5:{src:"tri-my-best-runner-breaks-finishline-tape",alt:"tri my best runner breaks yellow finishline tape"},6:{src:"tri-my-best-swimmer-holds-onto-pool-wall",alt:"tri my best swimmer holds onto pool wall"},7:{src:"tri-my-best-runner-triumphantly-crosses-finishline",alt:"tri my best runner triumphantly crosses finishline"},8:{src:"tri-my-best-participant-poses-with-mom-and-dad",alt:"tri my best participant poses with mom and dad"},9:{src:"tri-my-best-buddies-assist-participant-to-finishline",alt:"tri my best buddies assist participant to finishline"},10:{src:"tri-my-best-runner-with-buddies-pushes-to-the-finishline",alt:"tri my best runner with buddies pushes to the finishline"},11:{src:"tri-my-best-biker-bikes-beside-buddy",alt:"tri my best biker bikes beside buddy"},12:{src:"tri-my-best-participant-receiving-medal",alt:"tri my best participant receives medal from volunteer"},13:{src:"tri-my-best-swimmer",alt:"tri my best swimmer in mid stroke"},14:{src:"tri-my-best-participant-holds-certificate",alt:"tri my best participant poses holding certificate"},15:{src:"tri-my-best-swimmer-with-pink-pool-noodle-smiles",alt:"tri my best swimmer with pink pool noodle smiles at the camera"},16:{src:"tri-my-best-partcipant-holds-the-hand-of-volunteer",alt:"tri my best partcipant hold the hand of volunteer"},17:{src:"tri-my-best-runner-crosses-finishline-buddies-behind",alt:"tri my best runner crosses finishline with buddies behind"},18:{src:"tri-my-best-swimmer-touches-wall",alt:"tri my best swimmer touches wall"},19:{src:"tri-my-best-runner-runs-with-family",alt:"tri my best runner runs with family"},20:{src:"tri-my-best-runner-proudly-crosses-finishline",alt:"tri my best runner proudly crosses finishline"},21:{src:"tri-my-best-participant-Ellie-poses-with-family",alt:"tri my best participant Ellie poses with family"},22:{src:"tri-my-best-swimmer-delighted-while-swimming",alt:"tri my best swimmer delighted while swimming"},23:{src:"tri-my-best-particpant-rides-on-buddys-back",alt:"tri my best participant rides on buddy's back"}};let length=Object.keys(srcset).length,currentImage;const openLightbox=e=>{var t=window.scrollY;document.body.style.position="fixed",document.body.style.top=`-${t}px`,document.getElementById("lightbox").classList.toggle("is-open"),document.getElementById("lightbox").style.top=t+"px",displayImg(e)},changeImage=e=>{console.log(e),console.log(currentImage);let t=currentImage+e;0==t?t=length:t==length+1&&(t=1),console.log(t),displayImg(t-1)},displayImg=e=>{let t=document.getElementById("lightbox-source"),s=document.getElementById("lightbox-img"),i=(t.setAttribute("srcset",`../../images/webp/${srcset[e].src}@2x.webp 480w, ../../images/webp/${srcset[e].src}@3x.webp 700w, ../../images/webp/${srcset[e].src}@4x.webp 1400w`),s.setAttribute("srcset",`../../images/webp/${srcset[e].src}@2x.jpg 480w, ../../images/${srcset[e].src}@3x.jpg 700w, ../../images/webp/${srcset[e].src}@4x.jpg 1400w`),s.setAttribute("src",`../../images/webp/${srcset[e].src}@2x.jpg`),s.setAttribute("alt",srcset[e].alt),currentImage=e+1,document.getElementById("lightbox-index"));i.textContent=currentImage+"/"+length},closeLightbox=()=>{var e=document.body.style.top;document.getElementById("lightbox").classList.toggle("is-open"),document.body.style.position="",document.body.style.top="",window.scrollTo(0,-1*parseInt(e||"0"))},toggleBtn=document.getElementById("toggle-btn"),target=document.getElementById("target"),body=document.querySelector("body"),logo=document.getElementById("logo"),shadowLogo=document.getElementById("shadow-logo"),desktopDonate=document.getElementById("desktop-donate-btn"),nav=document.getElementById("nav"),navmenu=document.getElementById("nav-menu"),navlist=document.getElementById("nav-list"),navListItem=document.getElementsByClassName("nav__list-item"),navListLink=document.getElementsByClassName("nav__list-link"),navDropdown=document.getElementsByClassName("nav__dropdown"),navDropdownLink=document.getElementsByClassName("nav__dropdown-link"),workShadow=document.getElementById("work-shadow"),involvedShadow=document.getElementById("involved-shadow"),aboutShadow=document.getElementById("about-shadow"),dropdownToggle=document.getElementsByClassName("nav__dropdown-toggle-icon"),addScrolled=[logo,shadowLogo,desktopDonate,workShadow,involvedShadow,aboutShadow],scrolledOptions={threshold:1},resizeNavbar=new IntersectionObserver((e,t)=>{e.forEach(e=>{e.isIntersecting?(addScrolled.forEach(e=>{e.classList.remove("scrolled")}),Array.from(navListLink).forEach(e=>{e.classList.remove("scrolled")}),Array.from(navListItem).forEach(e=>{e.classList.remove("scrolled")}),Array.from(navDropdownLink).forEach(e=>{e.classList.remove("scrolled")})):e.isIntersecting||(addScrolled.forEach(e=>{e.classList.add("scrolled")}),Array.from(navListLink).forEach(e=>{e.classList.add("scrolled")}),Array.from(navListItem).forEach(e=>{e.classList.add("scrolled")}),Array.from(navDropdownLink).forEach(e=>{e.classList.add("scrolled")}))})},scrolledOptions),closeDropdowns=(resizeNavbar.observe(target),()=>{Array.from(dropdownToggle).forEach(e=>e.classList.remove("is-open")),Array.from(navDropdown).forEach(e=>e.classList.remove("is-open"))}),addIsActive=[toggleBtn,logo,shadowLogo,navmenu,navlist,body,nav],toggleMenu=()=>{closeDropdowns(),Array.from(navListItem).forEach(e=>e.classList.toggle("is-active")),Array.from(navDropdownLink).forEach(e=>e.classList.toggle("is-active")),addIsActive.forEach(e=>e.classList.toggle("is-active"))},toggleDropdown=(t,s)=>{t.children[0].classList.toggle("is-open"),document.getElementById(s).classList.toggle("is-open"),Array.from(navDropdown).forEach(e=>{e.id!==s&&e.classList.remove("is-open")}),Array.from(dropdownToggle).forEach(e=>{e!==t.children[0]&&e.classList.remove("is-open")})};!function(e){var t=e.createElement("script");t.setAttribute("data-trigger","triggerId"),t.setAttribute("data-account","9DBXMzwRHL"),t.setAttribute("src","https://cdn.userway.org/widget.js"),(e.body||e.head).appendChild(t)}(document);