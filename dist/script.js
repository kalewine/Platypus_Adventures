const stories=document.getElementsByClassName("story__slider-card"),storyContainer=document.getElementById("story-slider"),storyScreen=document.getElementById("story-screen"),dots=document.getElementsByClassName("story__indicators-dot");let shiftBy,currentIndex=1;const changeStory=e=>{var t=storyScreen.getBoundingClientRect().width;let s;var a=stories.length;1==(s=-1==e?currentIndex==a?1:currentIndex+1:1<currentIndex?currentIndex-1:a)?shiftBy=0:s==a?shiftBy=-(a-1)*t:1<s&&(shiftBy=-t*(s-1)),dots[s-1].classList.add("filled"),dots[currentIndex-1].classList.remove("filled"),storyContainer.style.transform=`translateX(${shiftBy}px)`,currentIndex=s},changeDot=e=>{var t=storyScreen.getBoundingClientRect().width,s=(Array.from(dots).forEach(e=>e.classList.remove("filled")),Array.from(dots).indexOf(e));e.classList.add("filled"),shiftBy=0==s?0:-t*s,currentIndex=s+1,storyContainer.style.transform=`translateX(${shiftBy}px)`},srcset={0:{src:"tri-my-best-runner-smiles-runs-with-buddies",alt:"smiling athlete in wheelchair wheeled across finish line"},1:{src:"athlete-rides-red-bike-helped-by-buddies",alt:"tri my best athlete rides assisted bike with support of buddies"},2:{src:"tri-my-best-biker-green-helmet",alt:"tri my best athlete rides assisted bike with support of buddies"},3:{src:"",alt:""},4:{src:"",alt:""},5:{src:"",alt:""},6:{src:"",alt:""}};let length=Object.keys(srcset).length,currentImage;const openLightbox=e=>{var t=window.scrollY;document.body.style.position="fixed",document.body.style.top=`-${t}px`,document.getElementById("lightbox").classList.toggle("is-open"),document.getElementById("lightbox").style.top=t+"px",displayImg(e)},changeImage=e=>{console.log(e),console.log(currentImage);let t=currentImage+e;0==t?t=length:t==length+1&&(t=1),console.log(t),displayImg(t-1)},displayImg=e=>{let t=document.getElementById("lightbox-source"),s=document.getElementById("lightbox-img"),a=(t.setAttribute("srcset",`../../images/webp/${srcset[e].src}@1x.webp 500w, ../../images/webp/${srcset[e].src}@2x.webp 768w, ../../images/webp/${srcset[e].src}@3x.webp 1400w`),s.setAttribute("srcset",`../../images/webp/${srcset[e].src}@1x.jpg 500w, ../../images/${srcset[e].src}@2x.jpg 768w, ../../images/webp/${srcset[e].src}@3x.jpg 1400w`),s.setAttribute("src",`../../images/webp/${srcset[e].src}@2x.jpg`),s.setAttribute("alt",srcset[e].alt),currentImage=e+1,document.getElementById("lightbox-index"));a.textContent=currentImage+"/"+length},closeLightbox=()=>{var e=document.body.style.top;document.getElementById("lightbox").classList.toggle("is-open"),document.body.style.position="",document.body.style.top="",window.scrollTo(0,-1*parseInt(e||"0"))},toggleBtn=document.getElementById("toggle-btn"),target=document.getElementById("target"),body=document.querySelector("body"),logo=document.getElementById("logo"),shadowLogo=document.getElementById("shadow-logo"),desktopDonate=document.getElementById("desktop-donate-btn"),nav=document.getElementById("nav"),navmenu=document.getElementById("nav-menu"),navlist=document.getElementById("nav-list"),navListItem=document.getElementsByClassName("nav__list-item"),navListLink=document.getElementsByClassName("nav__list-link"),navDropdown=document.getElementsByClassName("nav__dropdown"),navDropdownLink=document.getElementsByClassName("nav__dropdown-link"),workShadow=document.getElementById("work-shadow"),involvedShadow=document.getElementById("involved-shadow"),aboutShadow=document.getElementById("about-shadow"),dropdownToggle=document.getElementsByClassName("nav__dropdown-toggle-icon"),addScrolled=[logo,shadowLogo,desktopDonate,workShadow,involvedShadow,aboutShadow],scrolledOptions={threshold:1},resizeNavbar=new IntersectionObserver((e,t)=>{e.forEach(e=>{e.isIntersecting?(addScrolled.forEach(e=>{e.classList.remove("scrolled")}),Array.from(navListLink).forEach(e=>{e.classList.remove("scrolled")}),Array.from(navListItem).forEach(e=>{e.classList.remove("scrolled")}),Array.from(navDropdownLink).forEach(e=>{e.classList.remove("scrolled")})):e.isIntersecting||(addScrolled.forEach(e=>{e.classList.add("scrolled")}),Array.from(navListLink).forEach(e=>{e.classList.add("scrolled")}),Array.from(navListItem).forEach(e=>{e.classList.add("scrolled")}),Array.from(navDropdownLink).forEach(e=>{e.classList.add("scrolled")}))})},scrolledOptions),closeDropdowns=(resizeNavbar.observe(target),()=>{Array.from(dropdownToggle).forEach(e=>e.classList.remove("is-open")),Array.from(navDropdown).forEach(e=>e.classList.remove("is-open"))}),addIsActive=[toggleBtn,logo,shadowLogo,navmenu,navlist,body,nav],toggleMenu=()=>{closeDropdowns(),Array.from(navListItem).forEach(e=>e.classList.toggle("is-active")),Array.from(navDropdownLink).forEach(e=>e.classList.toggle("is-active")),addIsActive.forEach(e=>e.classList.toggle("is-active"))},toggleDropdown=(t,s)=>{t.children[0].classList.toggle("is-open"),document.getElementById(s).classList.toggle("is-open"),Array.from(navDropdown).forEach(e=>{e.id!==s&&e.classList.remove("is-open")}),Array.from(dropdownToggle).forEach(e=>{e!==t.children[0]&&e.classList.remove("is-open")})};class PlatypusFooter extends HTMLElement{connectedCallback(){this.innerHTML=`  <footer class="footer">
        ...
        </section>`}}customElements.define("platypus-sponsors",PlatypusSponsors);class IntroWaves extends HTMLElement{constructor(){super();const e=document.createElement("section"),t=(e.setAttribute("class","waves__container"),e.setAttribute("id","waves-intro"),document.createElement("img")),s=(t.setAttribute("class","waves__crests top-waves"),t.setAttribute("src","../../images/purple-waves-top.svg"),t.setAttribute("alt","upward wave crests"),document.createElement("img")),a=(s.setAttribute("class","waves__crests bottom-waves"),s.setAttribute("src","../../images/purple-waves-bottom.svg"),s.setAttribute("alt","downward wave crests"),document.createElement("div")),o=(a.setAttribute("class","waves__body waves__purple"),document.createElement("article")),n=(o.setAttribute("class","intro__content"),document.createElement("h1")),i=(n.setAttribute("class","intro__title"),n.textContent=this.getAttribute("intro-title"),document.createElement("p"));i.setAttribute("class","intro__text"),i.textContent=this.getAttribute("intro-text"),o.appendChild(n),o.appendChild(i),a.appendChild(o),e.appendChild(t),e.appendChild(a),e.appendChild(s),this.appendChild(e)}}class WavesDivider extends HTMLElement{constructor(){super();const e=document.createElement("section");e.setAttribute("class","waves__container");var t=this.getAttribute("background-color"),s=this.getAttribute("button-color"),d=this.getAttribute("link");const a=document.createElement("img"),o=(a.setAttribute("class","waves__crests top-waves"),a.setAttribute("src",`../../images/${t}-waves-top.svg`),a.setAttribute("alt","upward wave crests"),document.createElement("img")),n=(o.setAttribute("class","waves__crests bottom-waves"),o.setAttribute("src",`../../images/${t}-waves-bottom.svg`),o.setAttribute("alt","downward wave crests"),document.createElement("div")),i=(n.setAttribute("class","waves__body waves__"+t),document.createElement("article")),l=(i.setAttribute("class","divider__content"),document.createElement("h2")),r=(l.setAttribute("class","divider__text"),l.textContent=this.getAttribute("divider-text"),document.createElement("a"));if(r.setAttribute("href",""+d),r.setAttribute("class","button button__"+s),r.textContent=this.getAttribute("btn-text"),i.appendChild(l),this.hasAttribute("divider-paragraph")){const c=document.createElement("p");c.setAttribute("class","waves__paragraph"),c.textContent=this.getAttribute("divider-paragraph"),i.appendChild(c)}i.appendChild(r),n.appendChild(i),e.appendChild(a),e.appendChild(n),e.appendChild(o),this.appendChild(e)}}class HeaderWaves extends HTMLElement{constructor(){super();const e=document.createElement("section"),t=(e.setAttribute("class","header__waves"),document.createElement("img")),s=(t.setAttribute("class","waves__crests bottom-waves"),t.setAttribute("src","../../images/purple-waves-bottom.svg"),t.setAttribute("alt","downward wave crests"),document.createElement("div")),a=(s.setAttribute("class","waves__body waves__purple"),s.setAttribute("id","header-waves"),document.createElement("article")),o=(a.setAttribute("class","intro__content"),document.createElement("h1")),n=(o.setAttribute("class","intro__title"),o.textContent=this.getAttribute("intro-title"),document.createElement("p"));n.setAttribute("class","intro__text"),n.textContent=this.getAttribute("intro-text"),a.appendChild(o),a.appendChild(n),s.appendChild(a),e.appendChild(s),e.appendChild(t),this.appendChild(e)}}customElements.define("intro-waves",IntroWaves),customElements.define("waves-divider",WavesDivider),customElements.define("header-waves",HeaderWaves);